package com.xpel.store.flutter_kv_store;
...
/**
 * FlutterKvStorePlugin
 */
public class FlutterKvStorePlugin implements FlutterPlugin, MethodCallHandler {
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding flutterPluginBinding) {
        channel = new MethodChannel(flutterPluginBinding.getBinaryMessenger(), "flutter_lightweight_kv_store");
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        ...
        TlStoreLogger.log("[FlutterKvStorePlugin] receive: " + method + ", arguments: " + arguments);
    ...
    private static void _send(@NonNull Result result, @NonNull Map map) {
        TlStoreLogger.log("[FlutterKvStorePlugin] send: " + map);
        result.success(map);
    }
